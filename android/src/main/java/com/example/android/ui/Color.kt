...
val reder = Color(0xFFf87171)
val whiter = Color(0xFFf1f5f9)
val blackP = Color(0xFF111016)
val lighterGray = Color(0xFFf4f4f4)
val orange = Color(0xFFF5BF34)
